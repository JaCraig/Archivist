...
{
    /// <summary>
    /// Converts Tables to Card.
    /// </summary>
    public class TablesToCardConverter : IDataConverter
    {
        /// <summary>
        /// Converts Tables to Card.
        /// </summary>
        ...
        public static Card? Convert(Tables? file)
        {
            if (file is null)
                return null;
            var ReturnValue = (Card?)file.FirstOrDefault();
        ...
        /// <summary>
        /// Checks if conversion is possible from Tables to Card.
        /// </summary>
        /// <param name="source">The source type.</param>
        /// <param name="destination">The destination type.</param>
        /// <returns>True if conversion is possible, otherwise false.</returns>
        public bool CanConvert(Type source, Type destination) => source == typeof(Tables) && destination == typeof(Card);
