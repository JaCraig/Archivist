...
{
    /// <summary>
    /// Converts Tables to Feed.
    /// </summary>
    public class TablesToFeedConverter : IDataConverter
    {
        /// <summary>
        /// Converts Tables to Feed.
        /// </summary>
        ...
        public static Feed? Convert(Tables? file)
        {
            if (file is null)
                return null;
            var ReturnValue = (Feed?)file.FirstOrDefault();
        ...
        /// <summary>
        /// Checks if conversion is possible from Tables to Feed.
        /// </summary>
        /// <param name="source">The source type.</param>
        /// <param name="destination">The destination type.</param>
        /// <returns>True if conversion is possible, otherwise false.</returns>
        public bool CanConvert(Type? source, Type? destination) => source == typeof(Tables) && destination == typeof(Feed);
