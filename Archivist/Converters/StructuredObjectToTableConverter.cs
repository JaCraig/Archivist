...
{
    /// <summary>
    /// Converts a StructuredObject to a Table.
    /// </summary>
    public class StructuredObjectToTableConverter : IDataConverter
    {
        /// <summary>
        /// Converts a StructuredObject to a Table.
        /// </summary>
        ...
        public static Table? Convert(StructuredObject? file)
        {
            if (file is null)
                return null;
            var ReturnValue = new Table();
            ReturnValue.Columns.AddRange(file.Keys);
