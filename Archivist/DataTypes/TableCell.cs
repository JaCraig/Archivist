...
namespace Archivist.DataTypes
{
    ...
    public class TableCell : IComparable<TableCell>, IEquatable<TableCell>
    {
        ...
        /// </summary>
        /// <typeparam name="TValue">The type to convert the cell content to.</typeparam>
        /// <returns>The value of the cell as the specified type.</returns>
        public TValue GetValue<TValue>() => Content.To<TValue>();
