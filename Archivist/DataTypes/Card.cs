...
namespace Archivist.DataTypes
{
    ...
    public class Card : FileBaseClass<Card>, IComparable<Card>, IEquatable<Card>, IEnumerable<KeyValueField?>, IEnumerable, IObjectConvertable
    {
        ...
        /// <summary>
        /// Converts the card to a feed file.
        /// </summary>
        /// <param name="file">The card to convert.</param>
        /// <returns>The feed representation of the card.</returns>
        public static implicit operator Feed?(Card? file)
        {
            return CardToFeedConverter.Convert(file);
        }
        ...
        /// </summary>
        /// <param name="file">The card to convert.</param>
        /// <returns>The image representation of the card.</returns>
        public static implicit operator Image?(Card? file)
        {
