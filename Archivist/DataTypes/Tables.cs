...
namespace Archivist.DataTypes
{
    ...
    public class Tables : FileBaseClass<Tables>, IComparable<Tables>, IEquatable<Tables>, IListConvertable, IList<Table>
    {
        ...
        /// <summary>
        /// Converts the Tables to a Calendar.
        /// </summary>
        /// <param name="file">The Tables to convert.</param>
        public static implicit operator Calendar?(Tables? file)
        {
            return TablesToCalendarConverter.Convert(file);
        }
        ...
        /// <summary>
        /// Converts the Tables to a Feed.
        /// </summary>
        /// <param name="file">The Tables to convert.</param>
        /// <returns>The Feed converted from the Tables.</returns>
        public static implicit operator Feed?(Tables? file)
        {
            return TablesToFeedConverter.Convert(file);
        }
        ...
        public void CopyTo(Table[]? array, int arrayIndex)
        {
            ...
            var Count = Math.Min(array.Length - arrayIndex, TableEntries.Count);
            TableEntries.CopyTo(0, array, arrayIndex, Count);
        }
